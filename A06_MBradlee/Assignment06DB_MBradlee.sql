...
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_MBradlee')
	 Begin 
	  Alter Database [Assignment06DB_MBradlee] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_MBradlee;
	 End
	Create Database Assignment06DB_MBradlee;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_MBradlee;
...
Join vInventories i On p.ProductID = i.ProductID
Join vEmployees e on i.EmployeeID = e.EmployeeID
Order By i.InventoryDate, c.CategoryName, p.ProductName, 5
Go
